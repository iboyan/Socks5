...
## 一键安装或更新到最新 ##
 <pre><code>wget -q -N --no-check-certificate https://raw.githubusercontent.com/iboyan/Socks5/master/install.sh && bash install.sh</code></pre>

## 相关文件路径 ##
- 安装完后防火墙是关闭状态的，打开防火墙请放通Socks5端口<br>
